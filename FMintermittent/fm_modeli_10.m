function dy = fm_modeli_10(p, ndata)
% fm_modeli_10 is the function to wire passing through three interpolating 
% points suitable for pattern with holes but y is not bound
