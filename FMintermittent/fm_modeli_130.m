function dy = fm_modeli_130(p, ndata)
% fm_modeli_130 is the function to wire passing through four interpolating 
% points suitable for pattern with holes but yis un bound
