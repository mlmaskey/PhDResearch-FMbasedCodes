function dy = fm_modeli_330(p, ndata) % wire 
% fm_modeli_330 is the function to wire passing through four interpolating 
% points suitable for pattern with holes but y is unbound
