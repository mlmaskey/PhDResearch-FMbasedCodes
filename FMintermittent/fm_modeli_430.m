function dy = fm_modeli_430(p,ndata) 
% fm_modeli_430 is the function to leaf with three maps suitable 
% for pattern with holes but y is not bound
