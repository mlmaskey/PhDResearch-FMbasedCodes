function dy = fm_model_1001(p, ndata)

% This is the original wire passing by three points with parabilic
% coordinates dated 05/12/2014
...
x1 = p(1)*p(2);% x = sigma * tau
y1 = 1/2*(p(2)^2 - p(1)^2); % y = 1/2*(tau^2 - sigma^2)
